const CONTROL_CENTER_ROUTES = Object.freeze({
  tokens: '/registry/tokens/manifests/runtime-tokens.json',
  themes: '/registry/themes/website-themes.json',
  icons: '/registry/icons/manifests/icon-manifest.json',
  studio: '/registry/studio/core/index.json'
});
